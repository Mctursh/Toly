  ...
  return (
    <div className="relative w-full min-h-[503px]">
      <div className="relative w-full max-w-[969px] mx-auto"> {/* Updated to match design width */}
        ...
        >
          <h2 
            className={`max-w-[693px] text-[30px] font-bold leading-[130%] text-center tracking-[-0.02em] capitalize text-[#FAFAFA] ${inter.className}`}
          >
            Let's Get Started With Toly
          </h2>
          
          <p 
            className={`max-w-[593px] text-[18px] leading-[160%] text-center text-[#9097A6] ${spaceGrotesk.className}`}
          >
